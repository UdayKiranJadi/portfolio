   ...
   return (
     <div className='m-2'>
        ...
        <p className='mt-6 text-base text-gray-200 font-medium'>
            &quot; Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus, cupiditate! Sequi, veniam. Delectus beatae excepturi optio soluta iure ipsa magni nostrum. Eveniet architecto accusamus exercitationem animi, officiis ullam illum omnis? .&quot;
        </p>
