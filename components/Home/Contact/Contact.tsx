      ...
      <div className="w-[90%] md:w-[80%] lg:w-[70%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p className="text-gray-400 mt-6 text-base sm:text-lg">
            I’m open to full-time roles, internships, and project collaborations. Feel free to reach out happy to
            discuss opportunities, technical work.
          </p>

          <div className="mt-7">
            <div className="flex items-center space-x-3 mb-4">
              <BiPhone className="w-9 h-9 text-cyan-300" />
              <p className="text-xl font-bold text-gray-400">415-349-3797</p>
            </div>
          </div>
          ...
          <div className="mt-7">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <p className="text-xl font-bold text-gray-400">Los Angeles, USA</p>
            </div>
          </div>
