...
const MobileNav = ({closeNav, showNav}:Props) => {
  ...
  return (
    ...
    <div>
        ...
        <div className={`text-white ${navOpen} fixed justify-center flex-col h-full transform tranistion-all duration-500 delay-300 sm:w-[80%] sm:w[60%] bg-cyan-800 space-y-6 z-[100050] right-0`}>
         {Navlinks.map((link)=>{
